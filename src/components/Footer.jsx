...
const Footer = () => {
  ...
  <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
    ...
    <p className='text-xl font-bold py-4'>SCOMUSIK</p>
    </div>

    <p className="mx-auto mt-6 max-w-md text-center leading-relaxed text-gray-500">
      SCOMUSIK is commited to taking away the stress of locating 
      the clossest music store that musicians and instrumentalist face all over the worlds.
    </p>
